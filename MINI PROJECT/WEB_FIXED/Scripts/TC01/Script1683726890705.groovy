...
WebUI.setText(findTestObject('Object Repository/Register/Page_frontend-web/input_Nama Lengkap_input'), 'anggitan7272')

WebUI.setText(findTestObject('Register/Page_frontend-web/input_Email_input'), 'anggitan7272@gmail.com')

WebUI.setText(findTestObject('Object Repository/Register/Page_frontend-web/input_Password_input'), 'anggitan777')
