...
WebUI.click(findTestObject('Object Repository/Cart/button_AltaShop_v-btn v-btn--icon v-btn--ro_febe25'))

WebUI.setText(findTestObject('Object Repository/Cart/input_Email_input-433'), 'anggitan7272@gmail.com')

WebUI.setText(findTestObject('Object Repository/Cart/input_Password_input-436'), 'anggitan777')
...
WebUI.click(findTestObject('Object Repository/Cart/h3_AltaShop'))
